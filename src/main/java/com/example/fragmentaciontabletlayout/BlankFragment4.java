...
public class BlankFragment4 extends Fragment {
    ...
    public void mostrarDato(String nombrePala , String cantidad){

        datos.setText("Pala: " + nombrePala + "\nCantidad: " + cantidad);

    }

    @Override
    public void onViewCreated(View view, Bundle savedInstanceState) {                                       //Se utiliza para obtener una referencia al TextView que se definió en el archivo XML permitiendo que se
        datos = view.findViewById(R.id.tvF4);                                                   //pueda manipular
    }
